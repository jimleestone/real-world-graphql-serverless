...
export interface NexusGenFieldTypes {
  Article: { // field return type
    author: NexusGenRootTypes['Profile'] | null; // Profile
    body: string; // String!
  ...
  Query: { // field return type
    ...
    getArticles: NexusGenRootTypes['Articles'] | null; // Articles
    getComments: NexusGenRootTypes['Comment'][] | null; // [Comment!]
    getFeed: NexusGenRootTypes['Articles'] | null; // Articles
    getProfile: NexusGenRootTypes['Profile'] | null; // Profile
    getTags: string[] | null; // [String!]
  }
}
